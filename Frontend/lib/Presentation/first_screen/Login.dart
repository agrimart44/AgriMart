...
//       // Retrieve the Firebase user and authenticate with Stream Chat
//       await _authService.authenticateWithStream(FirebaseAuth.instance.currentUser);
...
//         MaterialPageRoute(
//             builder: (context) =>
//                 const FarmerView()), // Replace with your route
//       );
//     } catch (e) {
//       showDialog(
//         context: context,
...
//                                       // Authenticate with Stream Chat using the public method
//                                       await _authService.authenticateWithStream(
